    ...
    <div className="w-full bg-white overflow-hidden relative">
      ...
      >
        ...
        {[...Array(8)].map((_, index) => (
          ...
          >
            {/* Linha esquerda */}
            <div className="h-[2px] w-5 sm:w-10 bg-red-500"></div>
            ...
            <div className="flex items-center gap-[6px] mx-3">
              ...
              <div className="h-2 w-2 sm:h-3 sm:w-3 rounded-full bg-red-500"></div>
              <div className="h-2 w-2 sm:h-3 sm:w-3 rounded-full bg-red-500 hidden sm:block"></div>
              <div className="h-2 w-2 sm:h-3 sm:w-3 rounded-full bg-red-500 hidden sm:block"></div>
            </div>
      
            {/* Linha central curta */}
            <div className="h-[2px] w-20 bg-red-500 mx-2"></div>
            ...
            {/* Círculo final */}
            <div className="h-5 w-5 sm:w-6 sm:h-6 rounded-full bg-red-500 ml-3 animate-bounce"></div>
            <span className="text-[12px] sm:text-[16px] font-semibold tracking-wide text-red-600 ml-3">
              movimento
            </span>
            <div className="h-2 w-2 sm:h-3 sm:w-3 rounded-full bg-red-500 ml-3"></div>
            <span className="text-[12px] sm:text-[16px] font-semibold tracking-wide text-red-600 ml-3">
              história
            </span>
          </div>
