        ...
        <div className="w-[100%] bg-white " >
          <div  className="flex justify-start items-center  bg-white py-4 sm:pl-3 sm:pr-3 pl-2 pr-2 sm:pl-8 sm:ph-8">
            ...
            <div className="flex items-center gap-[4px] sm:gap-[6px] mx-3 ml-0 mr-0">
              ...
              <div className="h-2 w-2 sm:h-3 sm:w-3 rounded-full bg-red-500"></div>
              <div className="h-2 w-2 sm:h-3 sm:w-3 rounded-full bg-red-500"></div>
              <div className="h-2 w-2 sm:h-3 sm:w-3 rounded-full bg-red-500 hidden sm:visible"></div>
              <div className="h-2 w-2 sm:h-3 sm:w-3 rounded-full bg-red-500 hidden sm:visible"></div>
            </div>
            ...
            {/* Círculo final */}
            <div className="h-5 w-6 sm:w-6 sm:h-6 rounded-full bg-red-500 ml-3 animate-bounce"></div>
          </div>
      </div>
    );
  }